...
main = do
    ...
    xmonad  $ ewmh $ withUrgencyHook NoUrgencyHook $ docks def
        ...
        , (( 0, xF86XK_AudioLowerVolume ), spawn "wpctl set-volume -l \"1.0\" @DEFAULT_AUDIO_SINK@ 5%-")
        , (( 0, xF86XK_AudioRaiseVolume ), spawn "wpctl set-volume -l \"1.0\" @DEFAULT_AUDIO_SINK@ 5%+")
        ...
        , (( mod4Mask .|. controlMask, xK_s ), spawn "nautilus ~/Pictures/screenshots")
