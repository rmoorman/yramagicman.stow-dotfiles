...
-- if beatiful.use_icons == true then
...
theme.bg_focus  = xrdb.color8 .. 'ff'
theme.bg_urgent  = xrdb.color9 .. 'cc'
theme.bg_minimize   = xrdb.color8
theme.bg_systray = theme.bg_normal

theme.fg_normal = xrdb.foreground
theme.fg_focus  = xrdb.background .. 'ff'
...
theme = theme_assets.recolor_layout(theme, xrdb.background)
