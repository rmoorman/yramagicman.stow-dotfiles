...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(escape-glyph ((,class (:foreground "#adadad" :weight normal))))
   ...
   `(font-lock-type-face ((,class (:foreground "#adadad" :weight normal))))
   ...
   ;; Gnus faces
   `(gnus-group-news-1 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-news-1-low ((,class (:foreground "#adadad"))))
   `(gnus-group-news-2 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-news-2-low ((,class (:foreground "#adadad"))))
   `(gnus-group-news-3 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-news-3-low ((,class (:foreground "#adadad"))))
   `(gnus-group-news-4 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-news-4-low ((,class (:foreground "#adadad"))))
   `(gnus-group-news-5 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-news-5-low ((,class (:foreground "#adadad"))))
   `(gnus-group-news-low ((,class (:foreground "#adadad"))))
   `(gnus-group-mail-1 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-mail-1-low ((,class (:foreground "#adadad"))))
   `(gnus-group-mail-2 ((,class (:weight normal :foreground "#adadad"))))
   `(gnus-group-mail-2-low ((,class (:foreground "#adadad"))))
   `(gnus-group-mail-3 ((,class (:weight normal :foreground "#adadad"))))
   ...
   `(gnus-header-from ((,class (:weight normal :foreground "#adadad"))))
   ...
   ;; Message faces
   `(message-header-name ((,class (:foreground "#adadad" :weight normal))))
   ...
   `(message-separator ((,class (:foreground "#adadad" :weight normal))))
