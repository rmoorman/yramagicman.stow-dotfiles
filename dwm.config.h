...
static const char sel_background[] = "#bf616a";
...
static const char *emacs[]  = { "/home/jonathan/bin/emacs", "-c", ".", NULL };
...
static const char *firefox[]  = { "firefox", "--new-tab", "https://start.duckduckgo.com", NULL};
